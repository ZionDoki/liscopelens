...
class TestTest(unittest.TestCase):
    ...
    def test_Test_parser(self):
        ...
        context = TestParser(
            argparse.Namespace(user_config_file="liscopelens/config/user_config.toml", init_file="liscopelens/resources/test_template.json", results="results"),
            config=config).parse("test", GraphManager())

        # from liscopelens.parser.compatible import BaseCompatiblityParser
        # context = BaseCompatiblityParser(argparse.Namespace(),config=config).parse("test",context)
        # context.save("answer.json")
...
class TempTest(unittest.TestCase):
    ...
    def test(self):
        ...
        graph = GraphManager("liscopelens/resources/compatible_graph.json")
